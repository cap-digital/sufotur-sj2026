...
export function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-3 left-3 z-40 flex flex-col rounded-2xl bg-[#15181c] text-white shadow-2xl transition-all duration-200 lg:translate-x-0 ${
      ...
      >
        ...
        <button
          ...
          className="absolute -right-3 top-6 z-10 hidden h-6 w-6 items-center justify-center rounded-full border border-[var(--border)] bg-white text-[#15181c] shadow-md transition hover:bg-gray-50 lg:flex"
        >
        ...
        >
          ...
          {!collapsed && (
            <div className="leading-tight">
              <p className="text-sm font-bold">SUFOTUR</p>
